		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapbtpuidemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpuidemo-display": {
								"semanticObject": "sapbtpuidemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.uidemo",
									"url": sap.ui.require.toUrl("sap/btp/uidemo")
								}
							}
						}
					}
